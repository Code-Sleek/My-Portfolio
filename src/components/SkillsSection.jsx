...
const skills = [
    ...
    {name : "Kotlin", level: 60, category: "Frontend"},
    ...
    //Tools
    {name : "Git", level: 40, category: "Tools"},
    ...
    //Cloud Platforms
    {name : "Vercel", level: 30, category: "Cloud"},
            ...
            <div className="flex flex-wrap justify-center gap-4 mb-12">
                {categories.map((category, key) => (
                    <button
                        ...
                        activeCategory === category ? "bg-primary text-primary-foreground" : "bg-secondary/70 text-foreground hover:bg-secondary")}>{category}
                        </button>
                ))}
            </div>
